...
Needle-guide devices (robots) can potentially improve the accuracy of needle placement and address those clinical unmet needs. They are typically guided by transrectal ultrasound (TRUS), MRI, or a combination of both. However, even if the needle is physically guided by a needle-guide device outside the patient’s body, the needle tip can still deviate from the intended path due to the tissue-needle interaction, and fail to sample tissue from the target lesion or deliver the treatment accurately. 
